...
def display_players_tab(players: pd.DataFrame, officials: pd.DataFrame, player_stats: pd.DataFrame) -> None:
...
def main() -> None:
    ...
    with tab_players:
        display_players_tab(tables["players"], tables["officials"], player_stats)
